...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "pitch-gradient": "radial-gradient(ellipse at 50% 0%, rgba(0,255,135,0.12) 0%, transparent 70%)",
        "card-shine":     "linear-gradient(135deg, rgba(255,255,255,0.05) 0%, transparent 60%)",
        "hero-mesh":      "radial-gradient(ellipse 80% 50% at 50% -10%, rgba(0,255,135,0.15) 0%, transparent 60%), radial-gradient(ellipse 60% 40% at 80% 50%, rgba(0,229,255,0.08) 0%, transparent 50%)",
      },
      animation: {
      ...
      boxShadow: {
        ...
        "card-hover":      "0 0 0 1px rgba(0,255,135,0.3), 0 8px 60px rgba(0,255,135,0.1)",
