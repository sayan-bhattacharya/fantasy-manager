...
export default function SignIn({ enabledProviders }: Props) {
  ...
  const errorMsg =
    error === "CredentialsSignin" ? "Incorrect username or password."
    : error === "no_username"    ? "Please enter a username and password."
        ...
        >
          ...
          <div style={{ display:"flex", gap:"2.5rem", marginBottom:"3.5rem" }}>
            {[
              ...
              <div key={label}>
                <div style={{ fontSize:"1.5rem", fontWeight:800, color:"#00FF87", letterSpacing:"-0.03em" }}>{val}</div>
          ...
          >
            ...
            >
              ...
              <div style={{ marginBottom:"1rem" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    fontSize:     "0.9rem",
                    outline:      "none",
                    boxShadow:    focused === "user" ? "0 0 0 3px rgba(0,255,135,0.12)" : "none",
                ...
                <div style={{ position:"relative" }}>
                  <input
                    ...
                    style={{
                      ...
                      fontSize:     "0.9rem",
                      outline:      "none",
                      boxShadow:    focused === "pass" ? "0 0 0 3px rgba(0,255,135,0.12)" : "none",
                      transition:   "border-color 0.2s, box-shadow 0.2s",
                    }}
                  />
                  <button
              ...
              <button
                ...
                style={{ width:"100%", justifyContent:"space-between", opacity: loading ? 0.7 : 1 }}
              >
              ...
              {providers.length > 0 && (
                <>
                  ...
                  >
                    ...
                    <span style={{ fontSize:"0.72rem", color:"rgba(255,255,255,0.28)", fontWeight:600 }}>or continue with</span>
                    <div style={{ flex:1, height:1, background:"rgba(255,255,255,0.08)" }} />
                  </div>
