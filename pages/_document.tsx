  ...
  return (
    <Html lang="en">
      <Head>
        ...
        {/* OG */}
        <meta property="og:title" content="FantasyKick — Premium Fantasy Football" />
        <meta property="og:description" content="Build your dream squad, enter contests, and win big." />
