...
export default function SignUp({ enabledProviders, enablePasswordSignup }: Props) {
  ...
  const [focused,  setFocused]    = useState<"user" | "pass" | "confirm" | null>(null);
  ...
  const canSubmit = username.length >= 3 && password.length >= 6 && password === confirm && !loading;
  ...
  const errorMsg =
    error === "CredentialsSignin" ? "Username may already be taken."
    : error === "no_username"    ? "Please fill in all fields."
          ...
          <div style={{ marginBottom:"2.5rem" }}>
            <div
              style={{
                ...
                textTransform:"uppercase", color:"#00FF87", marginBottom:"1.2rem",
              }}
            >
              Free to Join
            </div>
            ...
            <p
              style={{
                marginTop:"1.2rem", fontSize:"0.95rem",
                color:"rgba(255,255,255,0.45)", lineHeight:1.6, maxWidth:380,
              }}
            >
              Pick 11 players, enter contests, win prizes. Join millions of managers competing every matchday.
            </p>
          </div>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:"0.9rem" }}>
            {[
              ...
              >
                ...
                <span style={{ fontSize:"0.87rem", color:"rgba(255,255,255,0.6)" }}>{text}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        >
          <div
            style={{
              ...
              borderRadius:"2rem", padding:"6px",
            }}
          >
            <div
              style={{
                background:"#0d0d14", borderRadius:"calc(2rem - 6px)",
                padding:"2.5rem 2rem",
            ...
            >
              ...
              <p style={{ fontSize:"0.82rem", color:"rgba(255,255,255,0.4)", margin:"0 0 1.8rem" }}>
              ...
              {errorMsg && (
                <div
                  style={{
                    ...
                    fontSize:"0.8rem", color:"#FCA5A5", marginBottom:"1.2rem",
              ...
              {enablePasswordSignup && (
                <>
                  ...
                  <div style={{ marginTop:"1rem" }}>
                    ...
                    <div style={{ position:"relative" }}>
                      <input
                        ...
                        style={{ ...inputStyle(focused === "pass"), paddingRight:"3rem" }}
                      />
                      <button
                        type="button"
                        ...
                        style={{
                          ...
                          color:"rgba(255,255,255,0.35)", fontSize:"0.85rem", padding:0,
                        }}
                      >
                        {showPass ? "🙈" : "👁"}
                      </button>
                    ...
                    {password.length > 0 && password.length < 6 && (
                      <p style={{ fontSize:"0.72rem", color:"#FCA5A5", margin:"4px 0 0" }}>
                  ...
                  <div style={{ marginTop:"1rem", marginBottom:"1.6rem" }}>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        borderColor: mismatch ? "#EF4444" : focused === "confirm" ? "#00FF87" : "rgba(255,255,255,0.09)",
                        boxShadow:   mismatch ? "0 0 0 3px rgba(239,68,68,0.15)"
                                  : focused === "confirm" ? "0 0 0 3px rgba(0,255,135,0.12)" : "none",
                      }}
                    />
                    {mismatch && (
                      <p style={{ fontSize:"0.72rem", color:"#FCA5A5", margin:"4px 0 0" }}>
                  ...
                  <button
                    ...
                    disabled={!canSubmit}
                    style={{ width:"100%", justifyContent:"space-between", opacity: canSubmit ? 1 : 0.45 }}
                  >
              ...
              {providers.length > 0 && (
                <>
                  ...
                  >
                    ...
                    <span style={{ fontSize:"0.72rem", color:"rgba(255,255,255,0.28)", fontWeight:600 }}>
                      {enablePasswordSignup ? "or sign up with" : "sign up with"}
                    </span>
                    <div style={{ flex:1, height:1, background:"rgba(255,255,255,0.08)" }} />
                  </div>
                  <div style={{ display:"flex", gap:"0.75rem" }}>
                    {providers.map((p) => (
                      ...
                      >
                        ...
                        <img src={p.logo} alt={p.name} width={18} height={18} style={{ filter: p.name === "github" ? "invert(1)" : "none" }} />
              ...
              >
                <p style={{ fontSize:"0.78rem", color:"rgba(255,255,255,0.35)", margin:0 }}>
                  ...
                  <a
                    ...
                    style={{ color:"#00FF87", textDecoration:"none", fontWeight:600 }}
                  >
                    Sign in
                  </a>
                </p>
                <a href="/privacy" style={{ fontSize:"0.72rem", color:"rgba(255,255,255,0.2)", textDecoration:"none" }}>
                  Privacy
                </a>
              </div>
            </div>
