    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <h1 className="display-xl reveal reveal-delay-1 mb-6">
              Build Your <span className="gradient-text">Dream Squad.</span>
              <br />
              Win Every <span className="gradient-text">Matchday.</span>
            </h1>
            ...
            >
              The most advanced open-source fantasy football platform. Draft
              players, enter mega contests, predict scorelines, and dominate 2.4
              million rivals.
            </p>
            ...
            <div className="reveal reveal-delay-4 flex justify-center">
              ...
              >
                <div className="card-inner flex items-center gap-3 px-5 py-3">
                  <span
        ...
        <section className="py-32 px-4 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {FEATURES.map((f, i) => (
              ...
              >
                <div
                  className="card-inner p-7 flex flex-col gap-4 h-full"
        ...
        <section
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 50% at 50% 50%, rgba(0,255,135,0.04) 0%, transparent 70%)",
          }}
        >
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
              {[
                ...
                <div
                  key={c.name}
                  className={`card-outer reveal reveal-delay-${i + 1} contest-${c.type}`}
                >
          ...
          <div className="max-w-4xl mx-auto text-center reveal">
            ...
            >
              <div className="card-inner py-20 px-8">
                ...
                <h2 className="display-lg mt-6 mb-6">Your Squad Awaits.</h2>
                <p
